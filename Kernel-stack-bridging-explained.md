# Kernel stack bridging explained

### know the files
The Linux kernel bridge module is composed of several files, each implementing a different aspect of the bridge's functionality. Here is a brief overview of each of them:
...
This is a very high-level and simplified explanation of the packet Rx and Tx flow in the Linux kernel's bridge module. 
